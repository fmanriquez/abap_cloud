...
CLASS zcl_data_fmc IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA: lt_travel   TYPE TABLE OF ztb_travel_m,
          lt_booking  TYPE TABLE OF ztb_booking_m,
          lt_book_sup TYPE TABLE OF ztb_booksuppl_m.
    ...
    INSERT:
        ztb_travel_m    FROM TABLE @lt_travel,
